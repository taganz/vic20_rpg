function NineSliceBoxStretched(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	// aixo es basa en que "sprite" te la forma de 9slice i la caixa el que fa es estirar el mig

	var _size = sprite_get_width(argument0) / 3;     // el tamany del sprite de text
	var _x1 = argument1;
	var _y1 = argument2;
	var _x2 = argument3;
	var _y2 = argument4;
	var _index = argument5;   // "background" es una de les imatges del sprite, tenen colors diferents
	var _w = _x2 - _x1;
	var _h = _y2 - _y1;
